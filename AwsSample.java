    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println(dkr.toString());
	        	...
	        	byte[ ] privateKeyInByte = privateKey.getBytes();
		    FileOutputStream privateKeyFile = new FileOutputStream("JavaTest.pem") ;
		    privateKeyFile.write(privateKeyInByte);
            ...
            String imageId = "ami-08842d60"; //Basic 32-bit Amazon Linux AMI
            String iType = "t2.micro";
